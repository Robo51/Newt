package robo51.newt.network;

import net.minecraft.entity.player.EntityPlayer;
import net.minecraft.entity.player.EntityPlayerMP;
import robo51.newt.lib.Constants;
import robo51.newt.network.packet.AbstractMessageHandler;
import robo51.newt.network.packet.bidirectional.AbstractBiMessageHandler;
import robo51.newt.network.packet.client.AbstractClientMessageHandler;
import robo51.newt.network.packet.server.AbstractServerMessageHandler;
...
public class PacketDispatcher
{
	...
	public static final void registerPackets() {
		...
		registerMessage(ChangeUseStateMessage.Handler.class, ChangeUseStateMessage.class);
	}
